...
case $option in
	1)
		echo "You chose PHP5.6"
		sudo apt-get -y install  php5.6 libapache2-mod-php php5.6-mcrypt php5.6-mbstring php5.6-curl php5.6-cli php5.6-mysql php5.6-gd php5.6-intl php5.6-xsl php5.6-soap
		;;
	2)
